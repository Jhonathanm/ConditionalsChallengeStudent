...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @objc func determineOutputMVP() -> String
    {
        ...
        ***************************************************/
        ...
        if totalMoney < firstChoiceCost{
            print("u can not purchase the item")
        }
    ...
    @objc func determineOutput1() -> String
    {
         ...
         ***************************************************/
        if totalMoney == firstChoiceCost{
            print("you have just enough for your first choice")
        }
        if totalMoney > firstChoiceCost{
            print("you have plenty of moeny for your first choice")
        }
        if totalMoney < firstChoiceCost{
            print("you dont have enough moeny for your first choice")
        }
